...
## Check the Coding [Guidelines](https://github.com/freemh/stylelint-rules/blob/main/CODING-GUIDELINES.md) that cover a thorough description of all the rules, plus the rules file [.stylelintrc](https://github.com/freemh/stylelint-rules/blob/main/.stylelintrc)
